...
const handleListeners=()=>{$('.interactor__start').on('click',(e)=>{console.log()
...
const handleParticles=()=>{Particles.init({selector:".canvas__start",color:["#faebd7","#2e295e","#ff0266"],connectParticles:true,})}
